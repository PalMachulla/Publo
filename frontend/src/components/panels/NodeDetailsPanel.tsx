...
interface NodeDetailsPanelProps {
  ...
  // 2024-12-11: Removed worldState - was legacy frontend orchestration, now using SSE streaming
  storyId?: string
  orchestratorNodeId?: string
  onCreateStoryNode?: (data: any) => void
  onSectionComplete?: (sectionId: string, content: string) => void // NEW: Handle content generated by orchestrator
  onContentChunk?: (sectionId: string, chunk: string, accumulated: string) => void // NEW: Streaming content chunk
  onContentComplete?: (sectionId: string, wordCount: number) => void // NEW: Trigger document refresh after write
        ...
        <div className="h-full flex flex-col overflow-hidden">
          ...
          {nodeType === 'story' ? (
            ...
            <div className="h-full flex flex-col">
              ...
              // 2024-12-11: Removed worldState - OrchestratorPanelStreaming uses SSE
              onSectionComplete={onSectionComplete}
              onContentChunk={onContentChunk}
              onContentComplete={(sectionId: string, wordCount: number) => {
                console.log('🔄 [NodeDetailsPanel] Content complete, triggering refresh for:', sectionId, wordCount, 'words')
